 ...
 */
final class Version20210918125731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answers (id INT AUTO_INCREMENT NOT NULL, tasks_id INT DEFAULT NULL, author_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, text VARCHAR(255) NOT NULL, favourite TINYINT(1) DEFAULT NULL, nick VARCHAR(64) DEFAULT NULL, INDEX IDX_50D0C606E3272D31 (tasks_id), INDEX IDX_50D0C606F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answers DROP FOREIGN KEY FK_50D0C606E3272D31');

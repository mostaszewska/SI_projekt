...
// */
//final class Version20210917174748 extends AbstractMigration
//{
...
//        $this->addSql('CREATE TABLE answers (id INT AUTO_INCREMENT NOT NULL, questions_id INT DEFAULT NULL, author_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, text VARCHAR(255) NOT NULL, favourite TINYINT(1) DEFAULT NULL, nick VARCHAR(64) DEFAULT NULL, INDEX IDX_50D0C606BCB134CE (questions_id), INDEX IDX_50D0C606F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
